...
@Component({
  ...
  templateUrl: "./xhair.component.html",
  styleUrls: ["./xhair.component.css"],
})
export class XhairComponent implements OnInit {
  cat = "X-Hairs";
  corner = "west_corner";
  Dates: any = {};
  keywords: any = {};
  ...
  constructor(
    ...
    let obj: SectionInfoWest["X-Hairs"] = {
          ...
          if (this.api.newsList) {
            ...
            for (const [key, value] of Object.entries(this.api.newsList)) {
              ...
              if (
                ...
                console.log(this.morecats["ISIS"]);
              }
            }
          }
        },
