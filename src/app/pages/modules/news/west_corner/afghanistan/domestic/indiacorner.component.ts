...
@Component({
  selector: "app-india",
  templateUrl: "./indiacorner.component.html",
  styleUrls: ["./indiacorner.component.css"],
})
export class DomesticAfgComponent implements OnInit {
  cat = "diplomat";
  ...
  loadmap = true;
  ngOnInit(): void {
    this.Dates["India Corner"] = "latest";
    this.keywords["India Corner"];
    this.page_number["India Corner"] = 1;
    ...
    this.fetch_sub_news("India Corner", false);
  ...
  fetch_sub_news(
    ...
    this.api
      ...
      .subscribe({
        ...
        complete: () => {
          this.loading["India Corner"] = false;
        },
      });
  }
